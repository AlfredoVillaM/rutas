...
import { SortCardsComponent } from './components/sort-cards/sort-cards.component';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, NgFor, ShowCardComponent, FormsModule, NgIf, ReactiveFormsModule, ShowFormComponent, SortCardsComponent],
